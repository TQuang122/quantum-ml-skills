...
SKILLS_ROOT = ROOT
EXPORT_ROOT = ROOT / "exports" / "claude-code"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Export local QML skills to a Claude Code-compatible layout."
    )
    parser.add_argument(
        "--source",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=EXPORT_ROOT,
        help="Claude Code export output directory. Defaults to skills/qml/exports/claude-code/.",
    )
    parser.add_argument(
        "--skill",
        type=str,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Install directly into a target Claude Code skills directory.",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
